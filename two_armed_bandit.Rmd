...
The result is the complement, therefore is 0.4
</div>
...
The same  result, the answer is 0.4. Since M1 is 0.6 then M2 is 0.4 or non-M1 is 0.4
</div>
...
The correct answer is * Posterior - $P(M_1 \text{ is Good} ~|~ \text{Win on } M_1)$ <br/> Prior - $P(M_1 \text{ is Good})$ <br/> Likelihood - $P(\text{Win on } M_1 ~|~ M_1 \text{ is Good})$
</div>
...
The correct answer is $P(M_1\text{ is good}~|~\text{data}) = 0.571$, <br/> $P(M_2\text{ is good}~|~\text{data}) = 0.429$
</div>
...
Exactly the same $P(M_1\text{ is good}~|~\text{data}) = 0.571$,<br/> $P(M_2\text{ is good}~|~\text{data}) = 0.429$
</div>
...
bandit_posterior(data = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "W", "L", "L", "L", "L", "W", "L", "L", "L", "L", "W", "W", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "L", "W", "L", "W", "L", "L"))
)
```
...
dt1<- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "L", "W", "L", "L", "W", "L", "W", "W", "L"))

dt2<- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "L", "W", "L", "W", "L", "L", "W", "W", "W"))

dt3<- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "W", "W", "W", "L", "L", "W", "L", "L", "W"))

dt4 <- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "W", "W", "L", "L", "W", "L", "W", "L", "L"))

dt5 <- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "L", "L", "L", "W", "L", "W", "L", "L", "L"))

bandit_posterior(dt1) %>% 
  bandit_posterior(dt2, prior = .)%>%
  bandit_posterior(dt3, prior = .)%>%
  bandit_posterior(dt4, prior = .)%>%
  bandit_posterior(dt5, prior = .)
```
...
data3 <-rbind(dt1,dt2,dt3,dt4,dt5)
plot_bandit_posterior(data3)

#It looks weird since they were made by five different trials. Let's make theme in one trial only so machine 1 and 2 are preserved
data4<- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "L", "L", "W", "L", "W", "W", "L", "L", "W", "L", "L", "W", "L", "L", "W", "L", "W", "L", "L", "W", "W", "W", "L", "L", "L", "L", "L", "L", "W", "W", "L", "L", "L", "L", "L", "L", "L", "L", "L", "W", "W", "W", "L", "L", "L", "W", "W", "L", "L"))

plot_bandit_posterior(data4)
```
